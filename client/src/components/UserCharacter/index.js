const UserCharacter = ({ data }) => {
  ...
  return (
    <div className="container">
      ...
      <div className="user-power is-size-3 is-text-centered pb-6">User's</div>
      ...
      <div className="container box statblock has-text-weight-bold is-size-6 has-text-centered" style={{ border: '4px solid rgba(1, 1, 1, 1)', borderRadius: '40px',  padding: '25px' }}>
        <div className="user-statblock is-size-3 is-text-centered pb-6">Stat Block</div>
        ...
        <div className="user-range columns"><span className="column is-right">RANGE:  </span><span className="column">{data.me.statblock.range}</span></div>
